...
class Bot_Alive:
    ...
    def alive_info():
        alive_info = f"""
<a href="https://telegram.dog/manusiarakitann"><b>UsergayKampang</a> SIAP MENUMBUK ASU 🔥.</b>
\n╭▻►▻►▻►▻►▻►◄◅◄◅◄◅◄◅╮
  🐍  • <b>Python :</b>    <code>v{versions.__python_version__}</code>
  💻  • <b>Pyrogram :</b>    <code>v{versions.__pyro_version__}</code>
  🐨  • <b>𝓚𝓸𝓪𝓵𝓪 🐨 ⁪⁬⁮⁮⁮⁮ :</b>    <a href="https://telegram.dog/manusiarakitann"><b>UsergayKampang</a>
╰▻►▻►▻►▻►▻►◄◅◄◅◄◅◄◅╯\n
...
"""
    ...
    def alive_buttons():
        buttons = [
            [
                InlineKeyboardButton(text="🌐  INFO", callback_data="settings_btn"),
